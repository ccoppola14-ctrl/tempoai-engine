...
async function createCatalogItems(locationId: string): Promise<Map<string, MenuItem>> {
  ...
  const variationToItem = new Map<string, MenuItem>();
...
async function createOrders(
  locationId: string,
  variationToItem: Map<string, MenuItem>
): Promise<void> {
  console.log('\n🧾 Creating orders...');
